...
\texttt{COPYING} in the source distribution \footnote{See
  \url{http://abcl.org/svn/trunk/tags/1.3.2/COPYING}} for
...
\texttt{abcl.jar} or possibly something like \texttt{abcl-1.3.2.jar} if
...
asdf-3.1.4 (see \cite{asdf}) is packaged as core component of \textsc{ABCL},
...
\code{abcl-contrib-1.3.2.jar}.  The contrib jar is not loaded by the
...
\url{http://abcl.org/svn/tags/1.3.2/contrib/abcl-asdf/README.markdown}.
...
\url{http://abcl.org/svn/tags/1.3.2/contrib/asdf-jar/README.markdown}.
...
\url{http://abcl.org/svn/tags/1.3.2/contrib/jss/README.markdown}
...
\url{http://abcl.org/svn/tags/1.3.2/contrib/jfli/README}.
...
\url{http://abcl.org/tags/1.3.2/contrib/asdf-install/README}.
...
a maintainence release.  We followed this in April 2015 with the
release of abcl-1.3.2.
