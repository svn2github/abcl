...
%%Preface to the second edition, abcl-1.1.1.
...
\texttt{COPYING} in the source distribution \footnote{See
  \url{http://svn.common-lisp.net/armedbear/tags/1.1.1/abcl/COPYING}} for
...
\texttt{abcl.jar} or possibly something like \texttt{abcl-1.1.1.jar} if
...
\code{abcl-contrib-1.1.1.jar}.  The contrib jar is not loaded by the
...
\url{http://svn.common-lisp.net/armedbear/tags/1.1.1/abcl/contrib/abcl-asdf/README.markdown}.
...
\url{http://svn.common-lisp.net/armedbear/tags/1.1.1/abcl/contrib/asdf-jar/README.markdown}.
...
\url{http://svn.common-lisp.net/armedbear/tags/1.1.1/abcl/contrib/jss/README.markdown}.
...
\url{http://svn.common-lisp.net/armedbear/tags/1.1.1/abcl/contrib/jfli/README}.
...
\url{http://svn.common-lisp.net/armedbear/tags/1.1.1/abcl/contrib/asdf-install/README}.
